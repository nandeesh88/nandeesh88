...
🔍 Skilled in Cloud Computing, Full-Stack Development and AI Integration
...
![CI/CD](https://img.shields.io/badge/CI%2FCD%20Pipelines-0A0A0A?style=for-the-badge&logo=circleci&logoColor=white)
...
![Prompt Engineering](https://img.shields.io/badge/Prompt%20Engineering-6C3483?style=for-the-badge&logoColor=white)
...
| 🔗 [**Gridwar — Real-Time Multiplayer**](https://github.com/nandeesh88/Gridwar---real-time-multiplayer-grid) | Real-time multiplayer grid game built with WebSockets |
| 🔗 [**Event-Driven Pipeline**](https://github.com/nandeesh88/event-driven-pipeline) | Event-driven data pipeline architecture on the cloud |
| 🔗 [**Task Manager Fullstack**](https://github.com/nandeesh88/task-manager-fullstack) | Full-stack task management app with REST API backend |
| 🔗 [**Profit Path**](https://github.com/nandeesh88/Profit-Path) | Financial insights and profit tracking dashboard |
